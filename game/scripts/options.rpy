...
init -1 python hide:
    ...
    config.window_title = u"Miko"

    config.name = "Miko"
    config.version = "1.2"

    config.window_icon = "visual/gui/window_icon.png"

    config.mouse = { }
    config.mouse["default"] = [
        ("visual/gui/cursor.png",  0, 0)

        ]

    _game_menu_screen = "game_menu_selector"

define config.name = _("Miko")
...
define config.save_directory = "SugarLie-1648337755"
...
define config.window_icon = "visual/gui/window_icon.png"
